...
RECIPES: List[Recipe] = [
    ...
    Recipe(
        id="distill_corn_whiskey", name="Corn Whiskey (Bourbon)",
        description="Distill corn beer into smooth corn whiskey. Premium spirit.",
        materials=[("corn_beer", 3)],
        skill="chemistry", difficulty=10, time_minutes=480,
        output_custom={"id": "corn_whiskey", "name": "Corn Whiskey", "weight": 1.5,
                       "category": "drink", "base_value": 1.50, "hydration": 3.0,
                       "stackable": True,
                       "extra": {"warmth_bonus": 20, "aim_penalty": -3, "courage_bonus": 5,
                                 "disinfect": True},
                       "description": "Smooth corn whiskey. The good stuff. Premium."},
        output_qty=2, category="food",
    ),
    Recipe(
        id="distill_fruit_brandy", name="Fruit Brandy",
        description="Distill berry beer into fruit brandy. Smooth and valuable.",
        materials=[("berry_beer", 3)],
        skill="chemistry", difficulty=11, time_minutes=480,
        output_custom={"id": "fruit_brandy", "name": "Fruit Brandy", "weight": 1.5,
                       "category": "drink", "base_value": 3.00, "hydration": 3.0,
                       "stackable": True,
                       "extra": {"warmth_bonus": 20, "aim_penalty": -3, "courage_bonus": 5,
                                 "disinfect": True},
                       "description": "Berry brandy. Rich, smooth, expensive."},
        output_qty=2, category="food",
    ),
    Recipe(
    ...
    Recipe(
        id="make_gin", name="Juniper Gin",
        description="Redistill whiskey with juniper berries. Makes gin.",
        materials=[("whiskey", 1), ("juniper_berries", 2)],
        skill="chemistry", difficulty=9, time_minutes=120,
        output_custom={"id": "gin", "name": "Juniper Gin", "weight": 1.5,
                       "category": "drink", "base_value": 2.00, "hydration": 3.0,
                       "stackable": True,
                       "extra": {"warmth_bonus": 15, "aim_penalty": -3,
                                 "disinfect": True},
                       "description": "Whiskey redistilled with juniper. Piney and sharp."},
