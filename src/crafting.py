...
RECIPES: List[Recipe] = [
    ...
    Recipe(
        id="make_mash", name="Grain Mash",
        description="Mix flour with water and let it ferment in a barrel. "
                    "First step in whiskey-making. Requires a mash barrel nearby.",
        materials=[("flour", 3)],
        skill="chemistry", difficulty=6, time_minutes=30,
        output_custom={"id": "grain_mash", "name": "Grain Mash", "weight": 3.0,
                       "category": "material", "base_value": 0.10,
                       "stackable": True, "perishable": True, "days_until_spoil": 7,
                       "description": "Fermenting grain mash. Distill into whiskey within a week."},
        output_qty=2,
        category="food",
    ),
    Recipe(
        id="distill_whiskey", name="Distill Whiskey",
        description="Run fermented mash through a copper still. "
                    "Requires a still nearby. Produces good frontier whiskey.",
        materials=[("grain_mash", 2)],
        skill="chemistry", difficulty=10, time_minutes=480,
        output_id="whiskey", output_qty=3,
        category="food",
    ),
    Recipe(
        id="brew_beer", name="Brew Beer",
        description="A rough frontier beer from grain and water. "
                    "Weaker than whiskey but easier to make. Requires mash barrel.",
        materials=[("flour", 2)],
        skill="chemistry", difficulty=6, time_minutes=240,
        output_custom={"id": "beer", "name": "Beer", "weight": 1.0,
                       "category": "drink", "base_value": 0.25,
                       "hydration": 10.0, "stackable": True,
                       "perishable": True, "days_until_spoil": 14,
                       "extra": {"warmth_bonus": 5, "aim_penalty": -1},
                       "description": "Cloudy frontier beer. Refreshing. Mildly intoxicating."},
        output_qty=3,
        category="food",
    ),
